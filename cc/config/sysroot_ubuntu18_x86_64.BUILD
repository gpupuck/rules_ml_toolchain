...
cc_toolchain_import(
    ...
    shared_library = "usr/lib/gcc/x86_64-linux-gnu/{gcc_version}/libgomp.so".format(gcc_version = GCC_VERSION),
    static_library = "usr/lib/gcc/x86_64-linux-gnu/{gcc_version}/libgomp.a".format(gcc_version = GCC_VERSION),
    visibility = ["//visibility:public"],
)
